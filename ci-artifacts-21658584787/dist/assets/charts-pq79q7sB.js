import { a as t, l as e, n as i } from './main-BWYXOf-Y.js';
function s(t) {
    return (t + 0.5) | 0;
}
...
function L(t) {
    ...
    return (
        Array.isArray(t)
            ? t.length >= 3 && ((e = { r: t[0], g: t[1], b: t[2], a: 255 }), t.length > 3 && (e.a = r(t[3])))
            : ((e = I(t, { r: 0, g: 0, b: 0, a: 1 })).a = r(e.a)),
        e
    );
}
function E(t) {
...
function Y(t, e, i, s) {
    let n, o, r;
    if (H(t)) for (o = t.length, n = 0; n < o; n++) e.call(i, t[n], n);
    else if (W(t)) for (r = Object.keys(t), o = r.length, n = 0; n < o; n++) e.call(i, t[r[n]], r[n]);
}
function U(t, e) {
    let i, s, n, o;
...
function Z(t, e, i) {
    ...
    let r;
    for (let a = 0; a < n; ++a) {
        if (((r = s[a]), !W(r))) continue;
        const e = Object.keys(r);
        for (let s = 0, n = e.length; s < n; ++s) o(e[s], t, r, i);
    }
    return t;
}
function G(t, e) {
    return Z(t, e, { merger: Q });
}
function Q(t, e, i) {
    if (!q(t)) return;
    const s = e[t],
        n = i[t];
    W(s) && W(n) ? G(s, n) : Object.prototype.hasOwnProperty.call(e, t) || (e[t] = X(n));
}
        ...
        (J[e] = (function (t) {
            const e = (function (t) {
                const e = t.split('.'),
                    i = [];
                let s = '';
                for (const n of e) ((s += n), s.endsWith('\\') ? (s = s.slice(0, -1) + '.') : (i.push(s), (s = '')));
                return i;
            })(t);
            return t => {
                for (const i of e) {
...
const Lt = t => ('start' === t ? 'left' : 'end' === t ? 'right' : 'center'),
    Et = (t, e, i) => ('start' === t ? e : 'end' === t ? i : (e + i) / 2);
const Rt = t => 0 === t || 1 === t,
    zt = (t, e, i) => -Math.pow(2, 10 * (t -= 1)) * Math.sin(((t - e) * rt) / i),
    Bt = (t, e, i) => Math.pow(2, -10 * t) * Math.sin(((t - e) * rt) / i) + 1,
    Ft = {
        linear: t => t,
        easeInQuad: t => t * t,
        easeOutQuad: t => -t * (t - 2),
        ...
        easeInOutExpo: t =>
            Rt(t) ? t : t < 0.5 ? 0.5 * Math.pow(2, 10 * (2 * t - 1)) : 0.5 * (2 - Math.pow(2, -10 * (2 * t - 1))),
        easeInCirc: t => (t >= 1 ? t : -(Math.sqrt(1 - t * t) - 1)),
        easeOutCirc: t => Math.sqrt(1 - (t -= 1) * t),
        easeInOutCirc: t =>
            (t /= 0.5) < 1 ? -0.5 * (Math.sqrt(1 - t * t) - 1) : 0.5 * (Math.sqrt(1 - (t -= 2) * t) + 1),
        easeInElastic: t => (Rt(t) ? t : zt(t, 0.075, 0.3)),
        easeOutElastic: t => (Rt(t) ? t : Bt(t, 0.075, 0.3)),
        easeInOutElastic(t) {
            const e = 0.1125;
            return Rt(t) ? t : t < 0.5 ? 0.5 * zt(2 * t, e, 0.45) : 0.5 + 0.5 * Bt(2 * t - 1, e, 0.45);
        },
        easeInBack(t) {
            const e = 1.70158;
            return t * t * ((e + 1) * t - e);
        ...
        easeInOutBounce: t => (t < 0.5 ? 0.5 * Ft.easeInBounce(2 * t) : 0.5 * Ft.easeOutBounce(2 * t - 1) + 0.5),
    };
function Ht(t) {
...
function Wt(t) {
    return Ht(t) ? t : new R(t);
}
function Vt(t) {
    return Ht(t) ? t : new R(t).saturate(0.5).darken(0.1).hexString();
}
const jt = ['x', 'y', 'borderWidth', 'radius', 'tension'],
    Nt = ['color', 'borderColor', 'backgroundColor'];
const $t = new Map();
function Yt(t, e, i) {
    return (function (t, e) {
        e = e || {};
        ...
        let s = $t.get(i);
        return (s || ((s = new Intl.NumberFormat(t, e)), $t.set(i, s)), s);
    })(e, i).format(t);
}
var Ut = {
    formatters: {
        ...
        numeric(t, e, i) {
            ...
            return (Object.assign(h, this.options.ticks.format), Yt(t, s, h));
        },
    },
};
...
function Zt(t, e, i) {
    return 'string' == typeof e ? Z(Kt(t, e), i) : Z(Kt(t, ''), e);
}
class Gt {
    constructor(t, e) {
        ((this.animation = void 0),
            ...
            (this.hover = {}),
            (this.hoverBackgroundColor = (t, e) => Vt(e.backgroundColor)),
            (this.hoverBorderColor = (t, e) => Vt(e.borderColor)),
            (this.hoverColor = (t, e) => Vt(e.color)),
            (this.indexAxis = 'x'),
        ...
        Object.defineProperties(n, {
            ...
            [e]: {
                ...
                get() {
                    const t = this[r],
                        e = o[s];
                    return W(t) ? Object.assign({}, e, t) : N(t, e);
                },
                set(t) {
                    this[r] = t;
                },
    ...
    [
        function (t) {
            (t.set('animation', {
                ...
                t.set('animations', {
                    colors: { type: 'color', properties: Nt },
...
function se(t, e, i, s, n) {
    ...
    if (!(isNaN(p) || p <= 0)) {
        switch ((t.beginPath(), f)) {
            default:
                (n ? t.ellipse(i, s, n / 2, p, 0, 0, rt) : t.arc(i, s, p, 0, rt), t.closePath());
                break;
            case 'triangle':
                ((c = n ? n / 2 : p),
                    t.moveTo(i + Math.sin(x) * c, s - Math.cos(x) * p),
                    (x += ut),
                    t.lineTo(i + Math.sin(x) * c, s - Math.cos(x) * p),
                    (x += ut),
                    t.lineTo(i + Math.sin(x) * c, s - Math.cos(x) * p),
                    t.closePath());
                break;
            case 'rectRounded':
                ((l = 0.516 * p),
                    (h = p - l),
                    (r = Math.cos(x + dt) * h),
                    (d = Math.cos(x + dt) * (n ? n / 2 - l : h)),
                    (a = Math.sin(x + dt) * h),
                    (u = Math.sin(x + dt) * (n ? n / 2 - l : h)),
                    t.arc(i - d, s - a, l, x - ot, x - ct),
                    t.arc(i + u, s - r, l, x - ct, x),
                    t.arc(i + d, s + a, l, x, x + ct),
                    t.arc(i - u, s + r, l, x + ct, x + ot),
                    t.closePath());
                break;
            case 'rect':
                if (!g) {
                ...
                x += dt;
            case 'rectRot':
                ((d = Math.cos(x) * (n ? n / 2 : p)),
                    (r = Math.cos(x) * p),
                    (a = Math.sin(x) * p),
                    (u = Math.sin(x) * (n ? n / 2 : p)),
                    t.moveTo(i - d, s - a),
                    t.lineTo(i + u, s - r),
                    t.lineTo(i + d, s + a),
                    t.lineTo(i - u, s + r),
...
function ue(t, e) {
    ...
    (t.arc(i + r.topLeft, s + r.topLeft, r.topLeft, 1.5 * ot, ot, !0),
        t.lineTo(i, s + o - r.bottomLeft),
        t.arc(i + r.bottomLeft, s + o - r.bottomLeft, r.bottomLeft, ot, ct, !0),
        t.lineTo(i + n - r.bottomRight, s + o),
        t.arc(i + n - r.bottomRight, s + o - r.bottomRight, r.bottomRight, ct, 0, !0),
        t.lineTo(i + n, s + r.topRight),
        t.arc(i + n - r.topRight, s + r.topRight, r.topRight, 0, -ct, !0),
        t.lineTo(i + r.topLeft, s));
}
const fe = /^(normal|(\d+(?:\.\d+)?)(px|em|%)?)$/,
    ge = /^(normal|italic|initial|inherit|unset|(oblique( -?[0-9]?[0-9]deg)?))$/;
function pe(t, e) {
    const i = ('' + t).match(fe);
...
function me(t, e) {
    const i = {},
        s = W(e),
        n = s ? Object.keys(e) : e,
        o = W(t) ? (s ? i => N(t[i], t[e[i]]) : e => t[e]) : () => t;
    for (const r of n) i[r] = xe(o(r));
    return i;
}
function be(t) {
...
function ye(t, e) {
    ((t = t || {}), (e = e || Qt.font));
    let i = N(t.size, e.size);
    'string' == typeof i && (i = parseInt(i, 10));
    let s = N(t.style, e.style);
    s && !('' + s).match(ge) && (s = void 0);
    const n = {
        family: N(t.family, e.family),
        lineHeight: pe(N(t.lineHeight, e.lineHeight), i),
        size: i,
        style: s,
        weight: N(t.weight, e.weight),
        string: '',
    };
    return (
        (n.string = (function (t) {
...
function ve(t, e, i, s) {
    let n, o, r;
    for (n = 0, o = t.length; n < o; ++n) if (((r = t[n]), void 0 !== r && void 0 !== r)) return r;
}
function we(t, e, i) {
    const { min: s, max: n } = t,
        o = ((a = (n - s) / 2), 'string' == typeof (r = e) && r.endsWith('%') ? (parseFloat(r) / 100) * a : +r);
    var r, a;
    const h = (t, e) => (i && 0 === t ? 0 : t + e);
    return { min: h(s, -Math.abs(o)), max: h(n, o) };
}
function ke(t, e) {
    return Object.assign(Object.create(t), e);
}
function Me(t, e = [''], i, s, n = () => t[0]) {
    const o = i || t;
    void 0 === s && (s = Re('_fallback', t));
    const r = {
    ...
    return new Proxy(r, {
        ...
        get: (i, s) =>
            Oe(i, s, () =>
                (function (t, e, i, s) {
                    let n;
                    for (const o of e) if (((n = Re(Pe(o, t), i)), void 0 !== n)) return Ce(t, n) ? Le(i, s, t, n) : n;
                })(s, e, t, i)
            ),
...
function Se(t, e, i, s) {
    const n = {
        ...
        _stack: new Set(),
        _descriptors: De(t, s),
        setContext: e => Se(t, e, i, s),
        override: n => Se(t.override(n), e, i, s),
    };
    return new Proxy(n, {
                ...
                (function (t, e, i) {
                    ...
                    st(a) &&
                        ...
                        (a = (function (t, e, i, s) {
                            ...
                            a.add(t);
                            let h = e(o, r || s);
                            (a.delete(t), Ce(t, h) && (h = Le(n._scopes, n, t, h)));
                            return h;
                        })(e, a, t, i));
                    H(a) &&
                        a.length &&
                        (a = (function (t, e, i, s) {
                            ...
                            if (W(e[0])) {
                                ...
                                for (const h of i) {
                                    const i = Le(s, n, t, h);
                                    e.push(Se(i, o, r && r[t], a));
                                }
                            }
                            return e;
                        })(e, a, t, r.isIndexable));
                    Ce(e, a) && (a = Se(a, n, o && o[e], r));
                    return a;
                })(t, e, i)
            ),
...
const Pe = (t, e) => (t ? t + et(e) : e),
    Ce = (t, e) => W(e) && 'adapters' !== t && (null === Object.getPrototypeOf(e) || e.constructor === Object);
function Oe(t, e, i) {
...
const Ae = (t, e) => (!0 === t ? e : 'string' == typeof t ? tt(e, t) : void 0);
...
function Le(t, e, i, s) {
    const n = e._rootScopes,
        o = Te(e._fallback, i, s),
        r = [...t, ...n],
        a = new Set();
    a.add(s);
    let h = Ee(a, r, i, o || i, s);
    return (
        null !== h &&
        (void 0 === o || o === i || ((h = Ee(a, r, o, h, s)), null !== h)) &&
        Me(Array.from(a), [''], n, o, () =>
            (function (t, e, i) {
...
function Ve(t, e = 'x') {
    ...
    let r,
        ...
        l = Fe(t, 0);
    for (r = 0; r < s; ++r)
        if (((a = h), (h = l), (l = Fe(t, r + 1)), h)) {
            if (l) {
                const t = l[e] - h[e];
                n[r] = 0 !== t ? (l[i] - h[i]) / t : 0;
            }
            o[r] = a ? (l ? (gt(n[r - 1]) !== gt(n[r]) ? 0 : (n[r - 1] + n[r]) / 2) : n[r - 1]) : n[r];
        }
    (!(function (t, e, i) {
        const s = t.length;
        let n,
                ...
                h &&
                    ...
                    (pt(e[c], 0, Be)
                        ...
                        : ((n = i[c] / e[c]),
                          ...
                          a <= 9 || ((r = 3 / Math.sqrt(a)), (i[c] = n * r * e[c]), (i[c + 1] = o * r * e[c])))));
    })(t, n, o),
        (function (t, e, i = 'x') {
            const s = He(i),
                n = t.length;
            let o,
                ...
                h = Fe(t, 0);
            for (let l = 0; l < n; ++l) {
                if (((r = a), (a = h), (h = Fe(t, l + 1)), !a)) continue;
                const n = a[i],
                    c = a[s];
                (r && ((o = (n - r[i]) / 3), (a[`cp1${i}`] = n - o), (a[`cp1${s}`] = c - o * e[l])),
                    h && ((o = (h[i] - n) / 3), (a[`cp2${i}`] = n + o), (a[`cp2${s}`] = c + o * e[l])));
            }
        })(t, o, e));
}
function je(t, e, i) {
...
function Ne(t, e, i, s, n) {
    let o, r, a, h;
    if ((e.spanGaps && (t = t.filter(t => !t.skip)), 'monotone' === e.cubicInterpolationMode)) Ve(t, n);
    else {
        let i = s ? t[t.length - 1] : t[0];
        for (o = 0, r = t.length; o < r; ++o)
            ((a = t[o]),
                (h = We(i, a, t[Math.min(o + 1, r - (s ? 0 : 1)) % r], e.tension)),
                (a.cp1x = h.previous.x),
                (a.cp1y = h.previous.y),
                (a.cp2x = h.next.x),
                (a.cp2y = h.next.y),
        ...
        (function (t, e) {
            ...
            for (i = 0, s = t.length; i < s; ++i)
                ((r = o),
                    ...
                    o &&
                        ((n = t[i]),
                        r && ((n.cp1x = je(n.cp1x, e.left, e.right)), (n.cp1y = je(n.cp1y, e.top, e.bottom))),
                        a && ((n.cp2x = je(n.cp2x, e.left, e.right)), (n.cp2y = je(n.cp2y, e.top, e.bottom)))));
        })(t, i);
}
function $e() {
...
const Xe = t => t.ownerDocument.defaultView.getComputedStyle(t, null);
const qe = ['top', 'right', 'bottom', 'left'];
function Ke(t, e, i) {
    const s = {};
    i = i ? '-' + i : '';
    for (let n = 0; n < 4; n++) {
...
function Qe(t, e, i, s) {
    const n = Xe(t),
        o = Ke(n, 'margin'),
        r = Ue(n.maxWidth, t, 'clientWidth') || ht,
        a = Ue(n.maxHeight, t, 'clientHeight') || ht,
        h = (function (t, e, i) {
            let s, n;
            if (void 0 === e || void 0 === i) {
                ...
                if (o) {
                    const t = o.getBoundingClientRect(),
                        ...
                        a = Ke(r, 'border', 'width'),
                        h = Ke(r, 'padding');
                    ((e = t.width - h.width - a.width),
                        (i = t.height - h.height - a.height),
    ...
    ((l = Math.max(0, l - o.width)),
        ...
        (l = Ge(Math.min(l, r, h.maxWidth))),
        (c = Ge(Math.min(c, a, h.maxHeight))),
        l && !c && (c = Ge(l / 2)));
    return (
        (void 0 !== e || void 0 !== i) &&
            s &&
            h.height &&
            c > h.height &&
            ((c = h.height), (l = Ge(Math.floor(c * s)))),
        { width: l, height: c }
    );
}
function Je(t, e, i) {
    const s = e || 1,
        n = Ge(t.height * s),
        o = Ge(t.width * s);
    ((t.height = Ge(t.height)), (t.width = Ge(t.width)));
    const r = t.canvas;
    return (
        r.style &&
            (i || (!r.style.height && !r.style.width)) &&
            ((r.style.height = `${t.height}px`), (r.style.width = `${t.width}px`)),
        (t.currentDevicePixelRatio !== s || r.height !== n || r.width !== o) &&
            ((t.currentDevicePixelRatio = s), (r.height = n), (r.width = o), t.ctx.setTransform(s, 0, 0, s, 0, 0), !0)
    );
}
const ti = (function () {
    let t = !1;
    try {
        ...
        $e() && (window.addEventListener('test', null, e), window.removeEventListener('test', null, e));
    } catch (e) {}
    return t;
})();
function ei(t, e) {
...
function hi(t) {
    return 'angle' === t
        ? { between: kt, compare: vt, normalize: wt }
        : { between: St, compare: (t, e) => t - e, normalize: t => t };
}
...
function ci(t, e, i) {
    ...
    const { property: s, start: n, end: o } = i,
        r = e.length,
        { compare: a, between: h, normalize: l } = hi(s),
        {
            start: c,
            end: d,
            loop: u,
    ...
    const y = () => b || (h(n, m, p) && 0 !== a(n, m)),
        v = () => !b || 0 === a(o, p) || h(o, m, p);
    for (let w = c, k = c; w <= d; ++w)
        ((x = e[w % r]),
            x.skip ||
                ((p = l(x[s])),
                p !== m &&
                    ((b = h(p, n, o)),
                    null === _ && y() && (_ = 0 === a(p, n) ? w : k),
                    null !== _ && v() && (g.push(li({ start: _, end: w, loop: u, count: r, style: f })), (_ = null)),
                    (k = w),
                    (m = p))));
    return (null !== _ && g.push(li({ start: _, end: d, loop: u, count: r, style: f })), g);
}
function di(t, e) {
    const i = [],
        s = t.segments;
    for (let n = 0; n < s.length; n++) {
        const o = ci(s[n], t.points, e);
        o.length && i.push(...o);
    }
    return i;
}
        ...
        ? (function (t, e, i, s) {
              ...
              function f(t, e, s, n) {
                  ...
                  if (t !== e) {
                      ...
                      for (; i[e % h].skip; ) e += o;
                      t % h !== e % h &&
                          (l.push({ start: t % h, end: e % h, loop: s, style: n }), (c = n), (d = e % h));
                  }
              }
              for (const g of e) {
                  d = a ? d : g.start;
...
function xi(t, e) {
    ...
    const s = (function (t, e) {
        ...
        return i && s
            ? { left: pi(i, e, 'left'), right: pi(i, e, 'right'), top: pi(s, e, 'top'), bottom: pi(s, e, 'bottom') }
            : e;
    })(e, t.chartArea);
    return {
...
class vi {
    constructor(t, e, i, s) {
        const n = e[i];
        s = ve([t.to, s, n, t.from]);
        const o = ve([t.from, n, s]);
        ((this._active = !0),
            (this._fn = t.fn || yi[t.type || typeof o]),
            (this._easing = Ft[t.easing] || Ft.linear),
...
class wi {
    ...
    configure(t) {
        ...
        Object.getOwnPropertyNames(t).forEach(s => {
            ...
            ((H(n.properties) && n.properties) || [s]).forEach(t => {
    ...
    _createAnimations(t, e) {
        ...
        for (a = o.length - 1; a >= 0; --a) {
            ...
            d && d.duration ? ((n[h] = c = new vi(d, t, h, l)), s.push(c)) : (t[h] = l);
        }
        return s;
    }
    update(t, e) {
        ...
        return i.length ? (bi.add(this._chart, i), !0) : void 0;
    }
}
function ki(t, e) {
    const i = (t && t.options) || {},
...
function Si(t, e, i, s = {}) {
    ...
    for (r = 0, a = n.length; r < a; ++r) {
        ...
        ((l = t.values[h]), V(l) && (o || 0 === e || gt(e) === gt(l)) && (e += l));
    }
    return c || s.all ? e : 0;
}
function Di(t, e) {
...
function Oi(t, e) {
    ...
    for (let f = 0; f < d; ++f) {
        const t = e[f],
            { [h]: i, [l]: o } = t;
        ((u = (t._stacks || (t._stacks = {}))[l] = Pi(n, c, i)),
            (u[a] = o),
            (u._top = Ci(u, r, !0, s.type)),
            (u._bottom = Ci(u, r, !1, s.type)));
...
class Ei {
    ...
    linkScales() {
        const t = this.chart,
            ...
            n = (e.xAxisID = N(i.xAxisID, Ti(t, 'x'))),
            o = (e.yAxisID = N(i.yAxisID, Ti(t, 'y'))),
            r = (e.rAxisID = N(i.rAxisID, Ti(t, 'r'))),
            a = e.indexAxis,
    ...
    _destroy() {
        const t = this._cachedMeta;
        (this._data && Tt(this._data, this), t._stacked && Ai(t));
    }
    _dataCheck() {
    ...
    buildOrUpdateElements(t) {
        ...
        ((e._stacked = Di(e.vScale, e)),
            e.stack !== i.stack && ((s = !0), Ai(e), (e.stack = i.stack)),
            this._resyncElements(t),
            (s || n !== e._stacked) && (Oi(this, e._parsed), (e._stacked = Di(e.vScale, e))));
    }
    configure() {
    ...
    parseObjectData(t, e, i, s) {
        ...
        let l, c, d, u;
        for (l = 0, c = s; l < c; ++l)
            ((d = l + i), (u = e[d]), (h[l] = { x: n.parse(tt(u, r), d), y: o.parse(tt(u, a), d) }));
        return h;
    }
    getParsed(t) {
    ...
    applyStack(t, e, i) {
        const s = this.chart,
            n = this._cachedMeta,
            o = e[t.axis];
        return Si({ keys: Mi(s, !0), values: e._stacks[t.axis]._visualValues }, o, n.index, { mode: i });
    }
    updateRangeFromParsed(t, e, i, s) {
        const n = i[e.axis];
        let o = null === n ? NaN : n;
        const r = s && i._stacks[e.axis];
        (s && r && ((s.values = r), (o = Si(s, n, this._cachedMeta.index))),
    ...
    getMinMax(t, e) {
        const i = this._cachedMeta,
            ...
            a = ((t, e, i) => t && !e.hidden && e._stacked && { keys: Mi(i, !0), values: null })(e, i, this.chart),
    ...
    _update(t) {
        ...
        (this.update(t || 'default'),
            (e._clip = (function (t) {
                let e, i, s, n;
                return (
                    W(t) ? ((e = t.top), (i = t.right), (s = t.bottom), (n = t.left)) : (e = i = s = n = t),
    ...
    _resolveElementOptions(t, e = 'default', i) {
        ...
        return (f.$shared && ((f.$shared = a), (n[o] = Object.freeze(Li(f, a)))), f);
    }
    _resolveAnimations(t, e, i) {
        ...
        const h = new wi(s, a && a.animations);
    ...
    _resyncElements(t) {
        ...
        for (const [r, a, h] of this._syncList) this[r](a, h);
        this._syncList = [];
        const s = i.length,
            n = e.length,
            o = Math.min(n, s);
...
function Ri(t, e, i, s) {
    ...
    if (a && e === a.axis && 'r' !== e && r && o.length) {
        const r = a._reversePixels ? Ct : Pt;
        if (!s) {
            const s = r(o, e, i);
            if (h) {
                const { vScale: e } = n._cachedMeta,
                    ...
                    o = i
                        .slice(0, s.lo + 1)
                        .reverse()
                        .findIndex(t => !F(t[e.axis]));
                s.lo -= Math.max(0, o);
                const r = i.slice(s.hi).findIndex(t => !F(t[e.axis]));
                s.hi += Math.max(0, r);
            }
            return s;
        }
        ...
        zi(t, i, e, function (t, i, o) {
            const { startAngle: r, endAngle: a } = t.getProps(['startAngle', 'endAngle'], s),
                { angle: h } = (function (t, e) {
                    ...
                    return (o < -0.5 * ot && (o += rt), { angle: o, distance: n });
                })(t, { x: e.x, y: e.y });
            kt(h, r, a) && n.push({ element: t, datasetIndex: i, index: o });
        }),
        n
    );
}
function Hi(t, e, i, s, n, o) {
    ...
    return (
        zi(t, i, e, function (i, l, c) {
            ...
            const f = a(e, u);
            f < h
                ? ((r = [{ element: i, datasetIndex: l, index: c }]), (h = f))
                : f === h && r.push({ element: i, datasetIndex: l, index: c });
        }),
        r
    );
}
function Wi(t, e, i, s, n, o) {
    return o || t.isPointInArea(e) ? ('r' !== i || s ? Hi(t, e, i, s, n, o) : Fi(t, e, i, n)) : [];
}
function Vi(t, e, i, s, n) {
    ...
    return (
        zi(t, i, e, (t, s, h) => {
            t[r] &&
                t[r](e[i], n) &&
                (o.push({ element: t, datasetIndex: s, index: h }), (a = a || t.inRange(e.x, e.y, n)));
        }),
        s && !a ? [] : o
    );
}
    ...
    modes: {
        index(t, e, i, s) {
            const n = Ze(e, t),
                ...
                a = i.intersect ? Bi(t, n, o, s, r) : Wi(t, n, o, !1, s, r),
                h = [];
            return a.length
        ...
        dataset(t, e, i, s) {
            const n = Ze(e, t),
                o = i.axis || 'xy',
                r = i.includeInvisible || !1;
            let a = i.intersect ? Bi(t, n, o, s, r) : Wi(t, n, o, !1, s, r);
            if (a.length > 0) {
        ...
        point: (t, e, i, s) => Bi(t, Ze(e, t), i.axis || 'xy', s, i.includeInvisible || !1),
        nearest(t, e, i, s) {
            const n = Ze(e, t),
                o = i.axis || 'xy',
                r = i.includeInvisible || !1;
            return Wi(t, n, o, i.intersect, s, r);
        },
        x: (t, e, i, s) => Vi(t, Ze(e, t), 'x', i.intersect, s),
        y: (t, e, i, s) => Vi(t, Ze(e, t), 'y', i.intersect, s),
    },
};
const Ni = ['left', 'top', 'right', 'bottom'];
function $i(t, e) {
    return t.filter(t => t.pos === e);
}
function Yi(t, e) {
    return t.filter(t => -1 === Ni.indexOf(t.pos) && t.box.axis === e);
}
function Ui(t, e) {
    return t.sort((t, i) => {
        const s = e ? i : t,
...
function Xi(t, e) {
    ...
    for (o = 0, r = t.length; o < r; ++o) {
        ...
        a.horizontal
            ? ((a.width = l ? l * s : r && e.availableWidth), (a.height = n))
            : ((a.width = s), (a.height = l ? l * n : r && e.availableHeight));
    }
    return i;
}
function qi(t, e, i, s) {
...
function Zi(t, e, i, s) {
    ...
    o.getPadding && Ki(r, o.getPadding());
    const a = Math.max(0, e.outerWidth - qi(r, t, 'left', 'right')),
...
function Qi(t, e, i, s) {
    ...
    for (o = 0, r = t.length, l = 0; o < r; ++o) {
        ((a = t[o]), (h = a.box), h.update(a.width || e.w, a.height || e.h, Gi(a.horizontal, e)));
        const { same: r, other: d } = Zi(e, i, a, s);
        ((l |= r && n.length), (c = c || d), h.fullSize || n.push(a));
    }
    return (l && Qi(n, e, i, s)) || c;
}
...
function ts(t, e, i, s) {
    ...
    for (const a of t) {
        const t = a.box,
            h = s[a.stack] || { placed: 0, weight: 1 },
            l = a.stackWeight / h.weight || 1;
        if (a.horizontal) {
            const s = e.w * l,
                o = h.size || t.height;
            (it(h.start) && (r = h.start),
                t.fullSize ? Ji(t, n.left, r, i.outerWidth - n.right - n.left, o) : Ji(t, e.left + h.placed, r, s, o),
                (h.start = r),
                (h.placed += s),
                (r = t.bottom));
        } else {
            ...
            (it(h.start) && (o = h.start),
                t.fullSize ? Ji(t, o, n.top, r, i.outerHeight - n.bottom - n.top) : Ji(t, o, e.top + h.placed, r, s),
                (h.start = o),
                (h.placed += s),
                (o = t.right));
        }
...
var es = {
    ...
    update(t, e, i, s) {
        if (!t) return;
        const n = _e(t.options.layout.padding),
        ...
        (Qi(a.fullSize, f, d, g),
            ...
            ts(a.leftAndTop, f, d, g),
            (f.x += f.w),
            (f.y += f.h),
            ts(a.rightAndBottom, f, d, g),
            (t.chartArea = {
                left: f.left,
                top: f.top,
                right: f.left + f.w,
...
const ns = '$chartjs',
    ...
    rs = t => null === t || '' === t;
const as = !!ti && { passive: !0 };
function hs(t, e, i) {
    t && t.canvas && t.canvas.removeEventListener(e, i, as);
}
function ls(t, e) {
...
function ps(t, e, i) {
    ...
    return (
        r.observe(n),
        (function (t, e) {
            (us.size || window.addEventListener('resize', gs), us.set(t, e));
        })(t, o),
        r
    );
}
function xs(t, e, i) {
    (i && i.disconnect(),
        'resize' === e &&
            (function (t) {
                (us.delete(t), us.size || window.removeEventListener('resize', gs));
            })(t));
}
function ms(t, e, i) {
    const s = t.canvas,
...
class bs extends is {
    ...
    addEventListener(t, e, i) {
        ...
        const s = t.$proxies || (t.$proxies = {}),
            n = { attach: cs, detach: ds, resize: ps }[e] || ms;
        s[e] = n(t, e, i);
    }
    removeEventListener(t, e) {
        const i = t.$proxies || (t.$proxies = {}),
            s = i[e];
        if (!s) return;
        ((({ attach: xs, detach: xs, resize: xs })[e] || hs)(t, e, s), (i[e] = void 0));
    }
    getDevicePixelRatio() {
...
function ys(t, e) {
    ...
    if (r > 0) {
        ...
        for (vs(e, l, c, F(s) ? 0 : a - s, a), t = 0, i = r - 1; t < i; t++) vs(e, l, c, o[t], o[t + 1]);
        return (vs(e, l, c, h, F(s) ? e.length : h + s), l);
    }
    return (vs(e, l, c), l);
}
function vs(t, e, i, s, n) {
    const o = N(s, 0),
        r = Math.min(N(n, t.length), t.length);
    let a,
        h,
        l,
        c = 0;
    for (i = Math.ceil(i), n && ((a = n - s), (i = a / Math.floor(a / i))), l = o; l < 0; )
        (c++, (l = Math.round(o + c * i)));
    for (h = Math.max(o, 0); h < r; h++) h === l && (e.push(t[h]), c++, (l = Math.round(o + c * i)));
}
const ws = (t, e, i) => ('top' === e || 'left' === e ? t[e] + i : t[e] - i),
    ks = (t, e) => Math.min(e || t, t);
function Ms(t, e) {
    const i = [],
        s = t.length / e,
        n = t.length;
...
function Ps(t, e) {
    ...
    const i = ye(t.font, e),
        s = _e(t.padding);
    return (H(t.text) ? t.text.length : 1) * i.lineHeight + s.height;
}
function Cs(t, e, i) {
    let s = Lt(t);
    return (
...
class Os extends _s {
    ...
    getMinMax(t) {
        ...
        return ((i = o && i > s ? s : i), (s = n && i > s ? i : s), { min: j(i, j(s, i)), max: j(s, j(i, s)) });
    }
    getPadding() {
        return {
    ...
    update(t, e, i) {
        ...
        (this.beforeUpdate(),
            ...
            this._dataLimitsCached ||
                ...
                (this._range = we(this, n, s)),
                (this._dataLimitsCached = !0)),
            this.beforeBuildTicks(),
            (this.ticks = this.buildTicks() || []),
            this.afterBuildTicks());
        const a = r < this.ticks.length;
        (this._convertTicksToLabels(a ? Ms(this.ticks, r) : this.ticks),
            this.configure(),
    ...
    calculateLabelRotation() {
        const t = this.options,
            e = t.ticks,
            i = ks(this.ticks.length, t.ticks.maxTicksLimit),
            s = e.minRotation || 0,
            n = e.maxRotation;
        let o,
            r,
        ...
        ((o = t.offset ? this.maxWidth / i : u / (i - 1)),
            c + 6 > o &&
                ...
                (r = this.maxHeight - Ds(t.grid) - e.padding - Ps(t.title, this.chart.options.font)),
                (a = Math.sqrt(c * c + d * d)),
                (h =
                    Math.min(
    ...
    fit() {
        const t = { width: 0, height: 0 },
            ...
            r = this.isHorizontal();
        if (o) {
            const o = Ps(s, e.options.font);
            if (
                (r
                    ? ((t.width = this.maxWidth), (t.height = Ds(n) + o))
                    : ((t.height = this.maxHeight), (t.width = Ds(n) + o)),
    ...
    _computeLabelSizes(t, e, i) {
            ...
            if (
                ...
                if (H(d))
                    for (l = 0, c = d.length; l < c; ++l)
                        ((b = d[l]), F(b) || H(b) || ((x = Jt(s, g.data, g.gc, x, b)), (m += p)));
            } else ((x = Jt(s, g.data, g.gc, x, d)), (m = p));
            (o.push(x), r.push(m), (_ = Math.max(x, _)), (y = Math.max(m, y)));
        }
        !(function (t, e) {
            Y(t, t => {
                const i = t.gc,
        ...
        return { first: k(0), last: k(e - 1), widest: k(v), highest: k(w), widths: o, heights: r };
    }
    getLabelForValue(t) {
        return t;
    }
    ...
    getPixelForDecimal(t) {
        ...
        return Mt(this._alignToPixels ? te(this.chart, e, 0) : e, -32768, 32767);
    }
        ...
        if (t >= 0 && t < e.length) {
            ...
            return (
                ...
                (i.$context = (function (t, e, i) {
                    return ke(t, { tick: i, index: e, type: 'tick' });
                })(this.getContext(), t, i))
            );
        }
        return this.$context || (this.$context = ke(this.chart.getContext(), { scale: this, type: 'scale' }));
    }
    _tickSize() {
    ...
    _computeGridLineItems(t) {
        ...
        let x, m, b, _, y, v, w, k, M, S, D, P;
        if ('top' === o) ((x = p(this.bottom)), (v = this.bottom - c), (k = x - g), (S = p(t.top) + g), (P = t.bottom));
        else if ('bottom' === o)
            ((x = p(this.top)), (S = t.top), (P = p(t.bottom) - g), (v = x + g), (k = this.top + c));
        else if ('left' === o)
            ((x = p(this.right)), (y = this.right - c), (w = x - g), (M = p(t.left) + g), (D = t.right));
        else if ('right' === o)
            ((x = p(this.left)), (M = t.left), (D = p(t.right) - g), (y = x + g), (w = this.left + c));
        else if ('x' === e) {
            if ('center' === o) x = p((t.top + t.bottom) / 2 + 0.5);
            else if (W(o)) {
                const t = Object.keys(o)[0],
                    e = o[t];
                x = p(this.chart.scales[t].getPixelForValue(e));
            }
            ((S = t.top), (P = t.bottom), (v = x + g), (k = v + c));
        } else if ('y' === e) {
            if ('center' === o) x = p((t.left + t.right) / 2);
            else if (W(o)) {
                const t = Object.keys(o)[0],
                    e = o[t];
                x = p(this.chart.scales[t].getPixelForValue(e));
            }
            ((y = x - g), (w = y - c), (M = t.left), (D = t.right));
        }
        const C = N(s.ticks.maxTicksLimit, l),
        ...
        return ((this._ticksLength = l), (this._borderValue = x), d);
    }
    _computeLabelItems(t) {
        ...
        for (x = 0, m = r.length; x < m; ++x) {
            ((b = r[x]), (_ = b.label));
            const t = n.setContext(this.getContext(x));
            ((k = this.getPixelForTick(x) + n.labelOffset),
                (M = this._resolveTickFontOptions(x)),
                (S = M.lineHeight),
                (D = H(_) ? _.length : 1));
            const e = D / 2,
                i = t.color,
    ...
    drawBorder() {
        ...
        let h, l, c, d;
        (this.isHorizontal()
            ? ((h = te(t, this.left, o) - o / 2), (l = te(t, this.right, r) + r / 2), (c = d = a))
            : ((c = te(t, this.top, o) - o / 2), (d = te(t, this.bottom, r) + r / 2), (h = l = a)),
            e.save(),
            (e.lineWidth = n.width),
    ...
    drawLabels(t) {
        ...
        for (const n of s) {
            const t = n.options,
                i = n.font;
            de(e, n.label, 0, n.textOffset, i, t);
        }
        i && re(e);
    }
    drawTitle() {
        ...
        'bottom' === e || 'center' === e || W(e)
            ? ((a += o.bottom), H(i.text) && (a += n.lineHeight * (i.text.length - 1)))
            : (a += o.top);
        const {
            titleX: h,
            titleY: l,
            ...
            if (t.isHorizontal()) {
                ...
                } else f = 'center' === i ? (l.bottom + l.top) / 2 + p - e : ws(t, i, e);
                d = a - o;
            } else {
                if (W(i)) {
                    const t = Object.keys(i)[0],
                        s = i[t];
                    u = c[t].getPixelForValue(s) - x + e;
                } else u = 'center' === i ? (l.left + l.right) / 2 - x + e : ws(t, i, e);
                ((f = Et(s, r, n)), (g = 'left' === i ? -ct : ct));
            }
    ...
    _resolveTickFontOptions(t) {
        return ye(this.options.ticks.setContext(this.getContext(t)).font);
    }
    _maxDigits() {
...
class Ts {
    ...
    register(t) {
        ...
        return (
            n in s ||
                ((s[n] = t),
                (function (t, e, i) {
                    const s = Z(Object.create(null), [i ? Qt.get(i) : {}, Qt.get(e), t.defaults]);
                    (Qt.set(e, s),
                        t.defaultRoutes &&
                            (function (t, e) {
    ...
    unregister(t) {
        const e = this.items,
            i = t.id,
            s = this.scope;
        (i in e && delete e[i], s && i in Qt[s] && (delete Qt[s][i], this.override && delete Xt[i]));
    }
}
class As {
    constructor() {
        ((this.controllers = new Ts(Ei, 'datasets', !0)),
            (this.elements = new Ts(_s, 'elements')),
            (this.plugins = new Ts(Object, 'plugins')),
            (this.scales = new Ts(Os, 'scales')),
...
class Ls {
    ...
    _createDescriptors(t, e) {
        const i = t && t.config,
            s = N(i.options && i.options.plugins, {}),
            n = (function (t) {
                const e = {},
                    i = [],
                    s = Object.keys(Is.plugins.items);
                for (let o = 0; o < s.length; o++) i.push(Is.getPlugin(s[o]));
                const n = t.plugins || [];
        ...
        return !1 !== s || e
            ? (function (t, { plugins: e, localIds: i }, s, n) {
                  ...
                  for (const a of e) {
                      const e = a.id,
                          h = Es(s[e], n);
                      null !== h && o.push({ plugin: a, options: Rs(t.config, { plugin: a, local: i[e] }, h, r) });
                  }
                  return o;
              })(t, n, s, e)
            : [];
...
function Rs(t, { plugin: e, local: i }, s, n) {
    const o = t.pluginScopeKeys(e),
        r = t.getOptionScopes(s, o);
    return (
        i && e.defaults && r.push(e.defaults),
        t.createResolver(r, n, [''], { scriptable: !1, indexable: !1, allKeys: !0 })
    );
}
function zs(t, e) {
...
function Hs(t, ...e) {
    if (Bs(t)) return t;
    for (const i of e) {
        const e = i.axis || Fs(i.position) || (t.length > 1 && Bs(t[0].toLowerCase()));
        if (e) return e;
    }
            ...
            const a = Hs(
                    ...
                    (function (t, e) {
                        if (e.data && e.data.datasets) {
                            ...
                            if (i.length) return Ws(t, 'x', i[0]) || Ws(t, 'y', i[0]);
                        }
                        return {};
                    })(e, t),
                    Qt.scales[r.type]
                ...
                l = i.scales || {};
            o[e] = G(Object.create(null), [{ axis: a }, r, l[a], l[h]]);
        }),
        t.data.datasets.forEach(i => {
            const n = i.type || t.type,
                r = i.indexAxis || zs(n, e),
                a = (Xt[n] || {}).scales || {};
            Object.keys(a).forEach(t => {
                const e = (function (t, e) {
                    ...
                    n = i[e + 'AxisID'] || e;
                ((o[n] = o[n] || Object.create(null)), G(o[n], [{ axis: e }, s[n], a[t]]));
            });
        }),
        Object.keys(o).forEach(t => {
            const e = o[t];
            G(e, [Qt.scales[e.type], Qt.scale]);
        }),
        o
    );
}
function js(t) {
    ...
    ((e.plugins = N(e.plugins, {})), (e.scales = Vs(t, e)));
}
function Ns(t) {
...
class qs {
    constructor(t) {
        ((this._config = (function (t) {
            return (((t = t || {}).data = Ns(t.data)), js(t), t);
        })(t)),
    ...
    getOptionScopes(t, e, i) {
        ...
        const a = new Set();
        e.forEach(e => {
            (t && (a.add(t), e.forEach(e => Xs(a, t, e))),
                e.forEach(t => Xs(a, s, t)),
                e.forEach(t => Xs(a, Xt[n] || {}, t)),
                e.forEach(t => Xs(a, Qt, t)),
                e.forEach(t => Xs(a, qt, t)));
        });
        const h = Array.from(a);
        return (0 === h.length && h.push(Object.create(null)), Ys.has(e) && o.set(e, h), h);
    }
    chartOptionScopes() {
        const { options: t, type: e } = this;
        return [t, Xt[e] || {}, Qt.datasets[e] || {}, { type: e }, Qt, qt];
    }
    resolveNamedOptions(t, e, i, s = ['']) {
        const n = { $shared: !0 },
            { resolver: o, subPrefixes: r } = Ks(this._resolverCache, t, s);
        let a = o;
        if (
            (function (t, e) {
                ...
                for (const n of e) {
                    const e = i(n),
                        o = s(n),
                        r = (o || e) && t[n];
                    if ((e && (st(r) || Zs(r))) || (o && H(r))) return !0;
                }
                return !1;
            })(o, e)
        ) {
            n.$shared = !1;
            a = Se(o, (i = st(i) ? i() : i), this.createResolver(t, i, r));
        }
        for (const h of e) n[h] = a[h];
        return n;
    }
    createResolver(t, e, i = [''], s) {
        const { resolver: n } = Ks(this._resolverCache, t, i);
        return W(e) ? Se(n, e, void 0, s) : n;
    }
}
function Ks(t, e, i) {
    let s = t.get(e);
    ...
    let o = s.get(n);
    if (!o) {
        ((o = { resolver: Me(e, i), subPrefixes: i.filter(t => !t.toLowerCase().includes('hover')) }), s.set(n, o));
    }
    return o;
}
const Zs = t => W(t) && Object.getOwnPropertyNames(t).some(e => st(t[e]));
const Gs = ['top', 'bottom', 'left', 'right', 'chartArea'];
function Qs(t, e) {
    return 'top' === t || 'bottom' === t || (-1 === Gs.indexOf(t) && 'x' === e);
}
function Js(t, e) {
    return function (i, s) {
...
function sn(t) {
    return (
        $e() && 'string' == typeof t ? (t = document.getElementById(t)) : t && t.length && (t = t[0]),
...
class an {
    ...
    constructor(t, e) {
        ...
        ((this.platform = new (
            i.platform ||
            (function (t) {
                return !$e() || ('undefined' != typeof OffscreenCanvas && t instanceof OffscreenCanvas) ? ss : bs;
            })(s)
        )()),
        ...
        ((this.id = B()),
            ...
            r &&
                a &&
                (bi.listen(this, 'complete', tn),
                bi.listen(this, 'progress', en),
                this._initialize(),
    ...
    _initialize() {
        return (
            ...
            this.options.responsive ? this.resize() : Je(this, this.options.devicePixelRatio),
            this.bindEvents(),
    ...
    resize(t, e) {
        bi.running(this) ? (this._resizeBeforeDraw = { width: t, height: e }) : this._resize(t, e);
    }
    _resize(t, e) {
        ...
        (e &&
            ...
            Y(n, e => {
                const n = e.options,
                    ...
                    r = Hs(o, n),
                    a = N(n.type, e.dtype);
                ((void 0 !== n.position && Qs(n.position, r) === Qs(e.dposition)) || (n.position = e.dposition),
                    (s[o] = !0));
                let h = null;
                if (o in i && i[o].type === a) h = i[o];
                else {
                    ((h = new (Is.getScale(a))({ id: o, type: a, ctx: this.ctx, chart: this })), (i[h.id] = h));
                }
                h.init(n, t);
            }),
            Y(s, (t, e) => {
            ...
            Y(i, t => {
                (es.configure(this, t, t.options), es.addBox(this, t));
            }));
    }
    _updateMetasets() {
    ...
    buildOrUpdateControllers() {
        ...
        for (this._removeUnreferencedMetasets(), i = 0, s = e.length; i < s; i++) {
            ...
            if (
                ...
                const e = Is.getController(o),
                    { datasetElementType: s, dataElementType: r } = Qt.datasets[o];
                (Object.assign(e, { dataElementType: Is.getElement(r), datasetElementType: s && Is.getElement(s) }),
    ...
    _getUniformDataChanges() {
        ...
        const e = this.data.datasets.length,
            ...
            s = i(0);
        for (let n = 1; n < e; n++) if (!nt(s, i(n))) return;
        return Array.from(s)
            .map(t => t.split(','))
    ...
    _updateLayout(t) {
        ...
        es.update(this, this.width, this.height, t);
    ...
    render() {
        !1 !== this.notifyPlugins('beforeRender', { cancelable: !0 }) &&
            (bi.has(this) ? this.attached && !bi.running(this) && bi.start(this) : (this.draw(), tn({ chart: this })));
    }
    draw() {
        let t;
    ...
    getContext() {
        return this.$context || (this.$context = ke(null, { chart: this, type: 'chart' }));
    }
    ...
    _stop() {
        let t, e;
        for (this.stop(), bi.remove(this), t = 0, e = this.data.datasets.length; t < e; ++t)
    ...
    _handleEvent(t, e, i) {
        ...
        i && ((this._lastEvent = null), $(n.onHover, [t, r, this], this), a && $(n.onClick, [t, r, this], this));
        const l = !U(r, s);
...
function hn() {
    return Y(an.instances, t => t._plugins.invalidate());
}
function ln(t, e, i = e) {
    ((t.lineCap = N(i.borderCapStyle, e.borderCapStyle)),
        t.setLineDash(N(i.borderDash, e.borderDash)),
        (t.lineDashOffset = N(i.borderDashOffset, e.borderDashOffset)),
        (t.lineJoin = N(i.borderJoinStyle, e.borderJoinStyle)),
        (t.lineWidth = N(i.borderWidth, e.borderWidth)),
        (t.strokeStyle = N(i.borderColor, e.borderColor)));
}
function cn(t, e, i) {
    t.lineTo(i.x, i.y);
}
...
function un(t, e, i, s) {
    const { points: n, options: o } = e,
        { count: r, start: a, loop: h, ilen: l } = dn(n, i, s),
        c = (function (t) {
            return t.stepped ? ae : t.tension || 'monotone' === t.cubicInterpolationMode ? he : cn;
        })(o);
    let d,
        u,
        f,
...
function fn(t, e, i, s) {
    const n = e.points,
        { count: o, start: r, ilen: a } = dn(n, i, s),
    ...
    for (h && ((d = n[b(0)]), t.moveTo(d.x, d.y)), c = 0; c <= a; ++c) {
        ...
        const e = d.x,
            ...
            s = 0 | e;
        (s === u
            ? (i < f ? (f = i) : i > g && (g = i), (x = (m * x + e) / ++m))
            : (_(), t.lineTo(e, i), (u = s), (m = 0), (f = g = i)),
            (p = i));
    }
    _();
}
    ...
    pn && !e.options.segment
        ...
        : (function (t, e, i, s) {
              ...
              for (const a of n)
                  (ln(t, o, a.style),
                      t.beginPath(),
                      r(t, e, a, { start: i, end: i + s - 1 }) && t.closePath(),
                      t.stroke());
          })(t, e, i, s);
}
class mn extends _s {
    ...
    updateControlPoints(t, e) {
        ...
        if ((i.tension || 'monotone' === i.cubicInterpolationMode) && !i.stepped && !this._pointsUpdated) {
            ...
            (Ne(this._points, i, t, s, e), (this._pointsUpdated = !0));
        }
    }
    set points(t) {
    ...
    interpolate(t, e) {
        const i = this.options,
            s = t[e],
            n = this.points,
            o = di(this, { property: e, start: s, end: s });
        if (!o.length) return;
        const r = [],
            a = (function (t) {
                return t.stepped ? si : t.tension || 'monotone' === t.cubicInterpolationMode ? ni : ii;
            })(i);
        let h, l;
                  ...
                  return (
                      e.segments.forEach(({ start: t, end: e }) => {
                          ...
                          null !== s
                              ...
                              : null !== i && (o.push({ x: i, y: r.y }), o.push({ x: i, y: a.y }));
                      }),
                      o
                  );
              })(t, e)),
        i.length ? new mn({ points: i, options: { tension: 0 }, _loop: s, _fullLoop: s }) : null
    );
}
function kn(t) {
    return t && !1 !== t.fill;
...
function Sn(t, e, i) {
    const s = (function (t) {
        const e = t.options,
            i = e.fill;
        let s = N(i && i.target, i);
        void 0 === s && (s = !!e.backgroundColor);
        if (!1 === s || null === s) return !1;
        if (!0 === s) return 'origin';
        return s;
    })(t);
    if (W(s)) return !isNaN(s.value) && s;
    let n = parseFloat(s);
...
function Dn(t, e, i) {
    ...
    for (let n = 0; n < i.length; n++) {
        const o = i[n],
            { first: r, last: a, point: h } = Pn(o, e, 'x');
        if (!(!h || (r && a)))
            if (r) s.unshift(h);
...
class Cn {
    ...
    pathSegment(t, e, i) {
        ...
        return ((e = e || { start: 0, end: rt }), t.arc(s, n, o, e.end, e.start, !0), !i.bounds);
    }
    interpolate(t) {
...
function On(t) {
    ...
    if ('stack' === i)
        return (function (t) {
            ...
            a.push(wn({ x: null, y: e.bottom }, s));
            for (let h = 0; h < o.length; h++) {
                const t = o[h];
                for (let e = t.start; e <= t.end; e++) Dn(n, r[e], a);
            }
        ...
        if (e.getPointPositionForValue)
            return (function (t) {
                ...
                if (s.grid.circular) {
                    ...
                    return new Cn({ x: t.x, y: t.y, radius: e.getDistanceFromCenterForValue(r) });
                }
                for (let h = 0; h < n; ++h) a.push(e.getPointPositionForValue(h, r));
                return a;
            })(t);
        return (function (t) {
            const { scale: e = {}, fill: i } = t,
    ...
    return n instanceof Cn ? n : wn(n, s);
}
function Tn(t, e, i) {
    const s = On(e),
        { chart: n, index: o, line: r, scale: a, axis: h } = e,
        l = r.options,
        c = l.fill,
        d = l.backgroundColor,
    ...
    s &&
        ...
        (oe(t, i),
        (function (t, e) {
            const { line: i, target: s, above: n, below: o, area: r, scale: a, clip: h } = e,
            ...
            o !== n &&
                ('x' === l
                    ? (An(t, s, r.top),
                      Ln(t, { line: i, target: s, color: n, scale: a, property: l, clip: h }),
                      t.restore(),
                      t.save(),
                      An(t, s, r.bottom))
                    : 'y' === l &&
                      (In(t, s, r.left),
                      Ln(t, { line: i, target: s, color: o, scale: a, property: l, clip: h }),
                      t.restore(),
                      t.save(),
                      In(t, s, r.right),
                      (c = n)));
            (Ln(t, { line: i, target: s, color: c, scale: a, property: l, clip: h }), t.restore());
        })(t, { line: r, target: s, above: u, below: f, area: i, scale: a, axis: h, clip: p }),
        re(t));
}
function An(t, e, i) {
...
function In(t, e, i) {
    ...
    for (const a of s) {
        const { start: s, end: h } = a,
            l = n[s],
            c = n[yn(s, h, n)];
        (o ? (t.moveTo(l.x, l.y), (o = !1)) : (t.lineTo(i, l.y), t.lineTo(l.x, l.y)),
            (r = !!e.pathSegment(t, a, { move: r })),
            r ? t.closePath() : t.lineTo(i, c.y));
    }
    (t.lineTo(i, e.first().y), t.closePath(), t.clip());
}
function Ln(t, e) {
    const { line: i, target: s, property: n, color: o, scale: r, clip: a } = e,
        h = (function (t, e, i) {
            const s = t.segments,
                n = t.points,
                o = e.points,
            ...
            for (const a of s) {
                let { start: t, end: s } = a;
                s = yn(t, s, n);
                const h = _n(i, n[t], n[s], a.loop);
                if (!e.segments) {
                    r.push({ source: a, target: h, start: n[t], end: n[s] });
                    continue;
                }
                const l = di(e, h);
                for (const e of l) {
                    const t = _n(i, o[e.start], o[e.end], e.loop),
                        s = ci(a, n, t);
                    for (const n of s)
                        r.push({
                            source: n,
                            target: e,
                            start: { [i]: vn(h, t, 'start', Math.max) },
                            end: { [i]: vn(h, t, 'end', Math.min) },
                        });
                }
            }
            return r;
        })(i, s, n);
    for (const { source: l, target: c, start: d, end: u } of h) {
        const { style: { backgroundColor: e = o } = {} } = l,
            h = !0 !== s;
        (t.save(), (t.fillStyle = e), En(t, r, a, h && _n(n, d, u)), t.beginPath());
        const f = !!i.pathSegment(t, l);
        let g;
        if (h) {
            f ? t.closePath() : Rn(t, s, u, n);
            const e = !!s.pathSegment(t, c, { move: f, reverse: !0 });
            ((g = f && e), g || Rn(t, s, d, n));
        }
...
function En(t, e, i, s) {
    ...
    if ('x' === o || 'y' === o) {
        let e, s, h, l;
        ('x' === o ? ((e = r), (s = n.top), (h = a), (l = n.bottom)) : ((e = n.left), (s = r), (h = n.right), (l = a)),
            t.beginPath(),
            i &&
                ((e = Math.max(e, i.left)),
                (h = Math.min(h, i.right)),
                (s = Math.max(s, i.top)),
                (l = Math.min(l, i.bottom))),
            t.rect(e, s, h - e, l - s),
            t.clip());
    }
}
...
var zn = {
    ...
    afterDatasetsUpdate(t, e, i) {
        ...
        for (r = 0; r < s; ++r)
            ((o = t.getDatasetMeta(r)),
                ...
                (o.$filler = h),
                n.push(h));
        for (r = 0; r < s; ++r) ((h = n[r]), h && !1 !== h.fill && (h.fill = Mn(n, r, i.propagate)));
    },
    beforeDraw(t, e, i) {
        ...
        for (let r = n.length - 1; r >= 0; --r) {
            const e = n[r].$filler;
            e && (e.line.updateControlPoints(o, e.axis), s && e.fill && Tn(t.ctx, e, o));
        }
    },
    beforeDatasetsDraw(t, e, i) {
        ...
        for (let n = s.length - 1; n >= 0; --n) {
            const e = s[n].$filler;
            kn(e) && Tn(t.ctx, e, t.chartArea);
        }
    },
    beforeDatasetDraw(t, e, i) {
        const s = e.meta.$filler;
        kn(s) && 'beforeDatasetDraw' === i.drawTime && Tn(t.ctx, s, t.chartArea);
    },
...
class Fn extends _s {
    ...
    fit() {
        ...
        const i = t.labels,
            ...
            { boxWidth: r, itemHeight: a } = Bn(i, n);
        let h, l;
        ((e.font = s.string),
            this.isHorizontal()
                ? ((h = this.maxWidth), (l = this._fitRows(o, n, r, a) + 10))
                : ((l = this.maxHeight), (h = this._fitCols(o, s, r, a) + 10)),
    ...
    _fitCols(t, e, i, s) {
        ...
        return (
            this.legendItems.forEach((t, o) => {
                const { itemWidth: p, itemHeight: x } = (function (t, e, i, s, n) {
                ...
                (o > 0 &&
                    u + x + 2 * r > l &&
                    ((c += d + r), h.push({ width: d, height: u }), (f += d + r), g++, (d = u = 0)),
                    (a[o] = { left: f, top: u, col: g, width: p, height: x }),
                    (d = Math.max(d, p)),
                    (u += x + r));
            }),
            (c += d),
    ...
    adjustHitBoxes() {
        ...
        if (this.isHorizontal()) {
            let n = 0,
                r = Et(i, this.left + s, this.right - this.lineWidths[n]);
            for (const a of e)
                (n !== a.row && ((n = a.row), (r = Et(i, this.left + s, this.right - this.lineWidths[n]))),
                    (a.top += this.top + t + s),
                    (a.left = o.leftForLtr(o.x(r), a.width)),
                    (r += a.width + s));
        } else {
            let n = 0,
                r = Et(i, this.top + t + s, this.bottom - this.columnSizes[n].height);
            for (const a of e)
                (a.col !== n && ((n = a.col), (r = Et(i, this.top + t + s, this.bottom - this.columnSizes[n].height))),
                    (a.top = r),
                    (a.left += this.left + s),
    ...
    _draw() {
        const { options: t, columnSizes: e, lineWidths: i, ctx: s } = this,
            { align: n, labels: o } = t,
            r = Qt.color,
            a = oi(t.rtl, this.left, this.width),
            h = ye(o.font),
            { padding: l } = o,
            c = h.size,
            d = c / 2;
        ...
        (this.drawTitle(),
            ...
            (s.lineWidth = 0.5),
            (s.font = h.string));
        const { boxWidth: f, boxHeight: g, itemHeight: p } = Bn(o, c),
            x = this.isHorizontal(),
            m = this._computeTitleHeight();
        ((u = x
            ? { x: Et(n, this.left + l, this.right - i[0]), y: this.top + l + m, line: 0 }
            : { x: this.left + l, y: Et(n, this.top + m + l, this.bottom - e[0].height), line: 0 }),
        ...
        (this.legendItems.forEach((_, y) => {
            ...
            (a.setWidth(this.width),
                x
                    ? y > 0 &&
                      M + k + l > this.right &&
                      ((S = u.y += b), u.line++, (M = u.x = Et(n, this.left + l, this.right - i[u.line])))
                    : y > 0 &&
                      S + b > this.bottom &&
                      ((M = u.x = M + e[u.line].width + l),
                      u.line++,
                      (S = u.y = Et(n, this.top + m + l, this.bottom - e[u.line].height))));
            if (
                ((function (t, e, i) {
                    if (isNaN(f) || f <= 0 || isNaN(g) || g < 0) return;
                    s.save();
                    const n = N(i.lineWidth, 1);
                    if (
                        ((s.fillStyle = N(i.fillStyle, r)),
                        (s.lineCap = N(i.lineCap, 'butt')),
                        (s.lineDashOffset = N(i.lineDashOffset, 0)),
                        (s.lineJoin = N(i.lineJoin, 'miter')),
                        (s.lineWidth = n),
                        (s.strokeStyle = N(i.strokeStyle, r)),
                        s.setLineDash(N(i.lineDash, [])),
                        o.usePointStyle)
                    ) {
                        const r = {
                            ...
                            h = a.xPlus(t, f / 2);
                        se(s, r, h, e + d, o.pointStyleWidth && f);
                    } else {
                ...
                (M = ((t, e, i, s) => (t === (s ? 'left' : 'right') ? i : 'center' === t ? (e + i) / 2 : e))(
                    w,
                    M + f + d,
                    x ? M + k : this.right,
                    t.rtl
                ...
                (function (t, e, i) {
                    de(s, i.text, t, e + p / 2, h, { strikethrough: i.hidden, textAlign: a.textAlign(i.textAlign) });
                })(a.x(M), S, _),
                x)
            )
                u.x += k + l;
    ...
    drawTitle() {
        ...
        let l,
            ...
            d = this.width;
        if (this.isHorizontal())
            ((d = Math.max(...this.lineWidths)), (l = this.top + h), (c = Et(t.align, c, this.right - d)));
        else {
            const e = this.columnSizes.reduce((t, e) => Math.max(t, e.height), 0);
            l = h + Et(t.align, this.top, this.bottom - e - t.labels.padding - this._computeTitleHeight());
        }
        const u = Et(r, c, c + d);
        ((o.textAlign = n.textAlign(Lt(r))),
    ...
    _getLegendItemAt(t, e) {
        ...
        if (St(t, this.left, this.right) && St(e, this.top, this.bottom))
            for (n = this.legendHitBoxes, i = 0; i < n.length; ++i)
                if (((s = n[i]), St(t, s.left, s.left + s.width) && St(e, s.top, s.top + s.height)))
...
var Wn = {
    ...
    _element: Fn,
    start(t, e, i) {
        const s = (t.legend = new Fn({ ctx: t.ctx, options: i, chart: t }));
        (es.configure(t, s, i), es.addBox(t, s));
    },
    stop(t) {
        (es.removeBox(t, t.legend), delete t.legend);
    },
    beforeUpdate(t, e, i) {
        const s = t.legend;
        (es.configure(t, s, i), (s.options = i));
    },
    afterUpdate(t) {
        const e = t.legend;
...
class Vn extends _s {
    ...
    update(t, e) {
        ...
        const s = H(i.text) ? i.text.length : 1;
        this._padding = _e(i.padding);
        const n = s * ye(i.font).lineHeight + this._padding.height;
    ...
    _drawArgs(t) {
        ...
        return (
            this.isHorizontal()
                ? ((h = Et(r, i, n)), (l = e + t), (a = n - i))
                : ('left' === o.position
                      ? ((h = i + t), (l = Et(r, s, e)), (c = -0.5 * ot))
                      : ((h = n - t), (l = Et(r, e, s)), (c = 0.5 * ot)),
                  (a = s - e)),
...
var jn = {
    ...
    start(t, e, i) {
        !(function (t, e) {
            const i = new Vn({ ctx: t.ctx, options: e, chart: t });
            (es.configure(t, i, e), es.addBox(t, i), (t.titleBlock = i));
        })(t, i);
    },
    stop(t) {
        const e = t.titleBlock;
        (es.removeBox(t, e), delete t.titleBlock);
    },
    beforeUpdate(t, e, i) {
...
function Xn(t, e) {
    ...
    let p = g.height,
        x = 0,
        m = s.reduce((t, e) => t + e.before.length + e.lines.length + e.after.length, 0);
    if (
        ...
        p +=
            f * (e.displayColors ? Math.max(a, h.lineHeight) : h.lineHeight) +
            (m - f) * h.lineHeight +
            (m - 1) * e.bodySpacing;
    }
...
function Kn(t, e, i) {
    ...
    return { xAlign: i.xAlign || e.xAlign || qn(t, e, i, s), yAlign: s };
}
function Zn(t, e, i, s) {
    const { caretSize: n, caretPadding: o, cornerRadius: r } = t,
        { xAlign: a, yAlign: h } = i,
        l = n + o,
        { topLeft: c, topRight: d, bottomLeft: u, bottomRight: f } = be(r);
    let g = (function (t, e) {
        let { x: i, width: s } = t;
    ...
    return (
        ...
        { x: Mt(g, 0, s.width - e.width), y: Mt(p, 0, s.height - e.height) }
    );
}
function Gn(t, e, i) {
    const s = _e(i.padding);
...
class io extends _s {
    ...
    getContext() {
        return (
            ...
            (this.$context =
                ...
                ke(t, { tooltip: e, tooltipItems: i, type: 'tooltip' })))
        );
        var t, e, i;
    }
    getTitle(t, e) {
        const { callbacks: i } = e,
            ...
            n = eo(i, 'title', this, t),
            o = eo(i, 'afterTitle', this, t);
        let r = [];
        return ((r = $n(r, Yn(s))), (r = $n(r, Yn(n))), (r = $n(r, Yn(o))), r);
    }
    getBeforeBody(t, e) {
        return Qn(eo(e.callbacks, 'beforeBody', this, t));
    }
    getBody(t, e) {
        const { callbacks: i } = e,
            s = [];
        return (
            Y(t, t => {
                const e = { before: [], lines: [], after: [] },
                    n = Jn(i, t);
                ($n(e.before, Yn(eo(n, 'beforeLabel', this, t))),
                    $n(e.lines, eo(n, 'label', this, t)),
                    $n(e.after, Yn(eo(n, 'afterLabel', this, t))),
                    s.push(e));
            }),
            s
        );
    ...
    getAfterBody(t, e) {
        return Qn(eo(e.callbacks, 'afterBody', this, t));
    }
    getFooter(t, e) {
        const { callbacks: i } = e,
            s = eo(i, 'beforeFooter', this, t),
            n = eo(i, 'footer', this, t),
            o = eo(i, 'afterFooter', this, t);
        let r = [];
        return ((r = $n(r, Yn(s))), (r = $n(r, Yn(n))), (r = $n(r, Yn(o))), r);
    }
    _createItems(t) {
        ...
        return (
            ...
            Y(h, e => {
                ...
                (s.push(eo(i, 'labelColor', this, e)),
                    ...
                    o.push(eo(i, 'labelTextColor', this, e)));
            }),
            (this.labelColors = s),
    ...
    update(t, e) {
        ...
        let n,
            o = [];
        if (s.length) {
            const t = Nn[i.position].call(this, s, this._eventPosition);
            ...
            const e = (this._size = Xn(this, i)),
                r = Object.assign({}, t, e),
                a = Kn(this.chart, i, r),
                h = Zn(i, r, a, this.chart);
    ...
    getCaretPosition(t, e, i) {
        const { xAlign: s, yAlign: n } = this,
            ...
            { topLeft: a, topRight: h, bottomLeft: l, bottomRight: c } = be(r),
            { x: d, y: u } = t,
            { width: f, height: g } = e;
        let p, x, m, b, _, y;
        return (
            'center' === n
                ? ((_ = u + g / 2),
                  'left' === s
                      ? ((p = d), (x = p - o), (b = _ + o), (y = _ - o))
                      : ((p = d + f), (x = p + o), (b = _ - o), (y = _ + o)),
                  (m = p))
                : ((x =
                      'left' === s ? d + Math.max(a, l) + o : 'right' === s ? d + f - Math.max(h, c) - o : this.caretX),
                  'top' === n
                      ? ((b = u), (_ = b - o), (p = x - o), (m = x + o))
                      : ((b = u + g), (_ = b + o), (p = x + o), (m = x - o)),
                  (y = b)),
            { x1: p, x2: x, x3: m, y1: b, y2: _, y3: y }
        );
    }
    drawTitle(t, e, i) {
        const s = this.title,
        ...
        let o, r, a;
        if (n) {
            const h = oi(i.rtl, this.x, this.width);
            for (
                t.x = Gn(this, i.titleAlign, i),
                ...
                (e.fillText(s[a], h.x(t.x), t.y + o.lineHeight / 2),
                    (t.y += o.lineHeight + r),
    ...
    _drawColorBox(t, e, i, s, n) {
        ...
        if (n.usePointStyle) {
            ...
            ((t.lineWidth = W(o.borderWidth) ? Math.max(...Object.values(o.borderWidth)) : o.borderWidth || 1),
                (t.strokeStyle = o.borderColor),
            ...
            Object.values(r).some(t => 0 !== t)
                ? (t.beginPath(),
                  (t.fillStyle = n.multiKeyBackground),
                  ue(t, { x: e, y: f, w: h, h: a, radius: r }),
                  t.fill(),
                  t.stroke(),
                  (t.fillStyle = o.backgroundColor),
                  t.beginPath(),
                  ue(t, { x: i, y: f + 1, w: h - 2, h: a - 2, radius: r }),
                  t.fill())
                : ((t.fillStyle = n.multiKeyBackground),
                  t.fillRect(e, f, h, a),
                  t.strokeRect(e, f, h, a),
                  (t.fillStyle = o.backgroundColor),
                  t.fillRect(i, f + 1, h - 2, a - 2));
        }
    ...
    drawBody(t, e, i) {
        ...
        let d = c.lineHeight,
            u = 0;
        const f = oi(i.rtl, this.x, this.width),
            g = function (i) {
        ...
        for (
            ...
            for (
                x = s[_],
                    m = this.labelTextColors[_],
                    e.fillStyle = m,
                    Y(x.before, g),
                    b = x.lines,
                    r && b.length && (this._drawColorBox(e, t, _, f, i), (d = Math.max(c.lineHeight, a))),
                    y = 0,
                    w = b.length;
                y < w;
                ++y
    ...
    drawFooter(t, e, i) {
        ...
        let o, r;
        if (n) {
            const a = oi(i.rtl, this.x, this.width);
            for (
                t.x = Gn(this, i.footerAlign, i),
    ...
    _updateAnimationTarget(t) {
        const e = this.chart,
            ...
            n = i && i.y;
        if (s || n) {
            const i = Nn[t.position].call(this, this._active, this._eventPosition);
            if (!i) return;
            const o = (this._size = Xn(this, t)),
...
function ro(t, e) {
    ...
    let y,
        ...
        k,
        M = xt((p - g) / f / u) * u;
    if (M < 1e-14 && !x && !m) return [{ value: g }, { value: p }];
    ((k = Math.ceil(p / M) - Math.floor(g / M)),
        k > f && (M = xt((k * M) / f / u) * u),
        F(a) || ((y = Math.pow(10, a)), (M = Math.ceil(M * y) / y)),
        'ticks' === s ? ((v = Math.floor(g / M) * M), (w = Math.ceil(p / M) * M)) : ((v = g), (w = p)),
        x &&
        m &&
        n &&
        (function (t, e) {
            ...
            ? ((k = Math.round(Math.min((r - o) / M, l))), (M = (r - o) / k), (v = o), (w = r))
            : b
              ? ((v = x ? o : v), (w = m ? r : w), (k = h - 1), (M = (w - v) / k))
              : ((k = (w - v) / M), (k = pt(k, Math.round(k), M / 1e3) ? Math.round(k) : Math.ceil(k))));
    const S = Math.max(_t(M), _t(v));
    ((y = Math.pow(10, F(a) ? S : a)), (v = Math.round(v * y) / y), (w = Math.round(w * y) / y));
    let D = 0;
    for (
        x &&
        (d && v !== o
            ? (i.push({ value: o }), v < o && D++, pt(Math.round((v + D * M) * y) / y, o, ao(o, _, t)) && D++)
            : v < o && D++);
        D < k;
        ++D
    ) {
        const t = Math.round((v + D * M) * y) / y;
        if (m && t > r) break;
        i.push({ value: t });
    }
    return (
        m && d && w !== r
            ? i.length && pt(i[i.length - 1].value, r, ao(r, _, t))
                ? (i[i.length - 1].value = r)
                : i.push({ value: r })
            : (m && w !== r) || i.push({ value: w }),
        i
    );
}
...
class lo extends ho {
    static id = 'linear';
    static defaults = { ticks: { callback: Ut.formatters.numeric } };
    determineDataLimits() {
...
an.register(
    class extends Ei {
        ...
        update(t) {
            ...
            let { start: r, count: a } = (function (t, e, i) {
                ...
                let n = 0,
                    o = s;
                if (t._sorted) {
                    const { iScale: r, vScale: a, _parsed: h } = t,
                        l = t.dataset && t.dataset.options ? t.dataset.options.spanGaps : null,
                        c = r.axis,
                        { min: d, max: u, minDefined: f, maxDefined: g } = r.getUserBounds();
                    if (f) {
                        if (((n = Math.min(Pt(h, c, d).lo, i ? s : Pt(e, c, r.getPixelForValue(d)).lo)), l)) {
                            const t = h
                                .slice(0, n + 1)
                                .reverse()
                                .findIndex(t => !F(t[a.axis]));
                            n -= Math.max(0, t);
                        }
                        n = Mt(n, 0, s - 1);
                    }
                    if (g) {
                        let t = Math.max(
                            Pt(h, r.axis, u, !0).hi + 1,
                            i ? 0 : Pt(e, c, r.getPixelForValue(u), !0).hi + 1
                        );
                        if (l) {
                            const e = h.slice(t - 1).findIndex(t => !F(t[a.axis]));
                            t += Math.max(0, e);
                        }
                        o = Mt(t, n, s) - n;
                    } else o = s - n;
        ...
        updateElements(t, e, i, s) {
            const n = 'reset' === s,
                ...
                p = mt(f) ? f : Number.POSITIVE_INFINITY,
            ...
            for (let y = 0; y < b; ++y) {
                ...
                const b = this.getParsed(y),
                    v = F(b[u]),
                    w = (f[d] = o.getPixelForValue(b[d], y)),
                    k = (f[u] = n || v ? r.getBasePixel() : r.getPixelForValue(a ? this.applyStack(r, b, a) : b[u], y));
                ((f.skip = isNaN(w) || isNaN(k) || v),
                    (f.stop = y > 0 && Math.abs(b[d] - _[d]) > p),
                    g && ((f.parsed = b), (f.raw = h.data[y])),
                    c && (f.options = l || this.resolveDataElementOptions(y, i.active ? 'active' : s)),
                    x || this.updateElement(i, y, f, s),
                    (_ = b));
            }
        }
        getMaxOverflow() {
    ...
    class extends _s {
        ...
        inXRange(t, e) {
            return bn(this, t, 'x', e);
        }
        inYRange(t, e) {
            return bn(this, t, 'y', e);
        }
        getCenterPoint(t) {
            const { x: e, y: i } = this.getProps(['x', 'y'], t);
            return { x: e, y: i };
    ...
    class extends Os {
        ...
        parse(t, e) {
            ...
            return ((t, e) => (null === t ? null : Mt(Math.round(t), 0, e)))(
                (e = isFinite(e) && i[e] === t ? e : no(i, t, N(e, t), this._addedLabels)),
                i.length - 1
            );
        }
        determineDataLimits() {
...
function uo(t, e = 1) {
    return t.map(t => {
        const i = t / 100,
            s = e + i,
            n = 0 !== s ? i / s : 0;
        return Math.round(1e4 * n) / 100;
    });
}
function fo(t, e = 10, i = 1) {
    return uo(
        Array.from({ length: e }, (e, i) => t * (i + 1)),
        i
    );
}
function go(t) {
    if (t.max_stacks && t.max_stacks > 0) return t.max_stacks;
    if (t.stack_cap && t.stack_cap > 0 && t.stack_cap <= 100)
        return Math.min(t.stack_cap, t.scaling_per_stack?.length || 10);
    const e = t.scaling_per_stack || [];
    if (0 === e.length) return 10;
    for (let i = e.length - 1; i > 0; i--)
        if (e[i] !== e[i - 1]) {
            if (e.length - i >= 3) return i + 1;
            break;
        }
    return e.length;
}
function po(i, s, n, o = '', r = !1, a, h, l = {}) {
    const c = t(i);
    if (!c)
        return (
            e.warn({ operation: 'chart.init', data: { chartId: i, reason: 'canvas_not_found', chartType: 'scaling' } }),
            null
        );
    co[i] && co[i].destroy();
    let d = s;
    'hyperbolic' === l.scalingFormulaType && (d = uo(s, l.hyperbolicConstant || 1));
    const u = h || d.length,
        f = d.slice(0, u),
        g = f.map((t, e) => `${e + 1}`),
        p = o.includes('chance') || o.includes('percentage') || o.includes('damage') || o.includes('crit'),
        x = [
            {
                label: n,
                data: f,
    ...
    let m = !1,
        b = [],
        _ = 'Secondary';
    (a && (Array.isArray(a) ? ((b = a), (m = b.length > 0)) : ((b = a.values || []), (_ = a.stat), (m = b.length > 0))),
        m &&
            x.push({
                label: _,
                data: b.slice(0, u),
    ...
    const y = c.getContext('2d'),
        v = {
            ...
            plugins: { legend: { display: m }, tooltip: { enabled: !0 } },
            scales: {
                x: { title: { display: r, text: 'Stacks' }, grid: { color: 'rgba(255, 255, 255, 0.1)' } },
                y: {
                    position: 'left',
                    title: { display: r, text: p ? '%' : 'Value' },
                    beginAtZero: !0,
                    grid: { color: 'rgba(255, 255, 255, 0.1)' },
                },
                y2: { position: 'right', display: m, grid: { drawOnChartArea: !1 } },
            },
        };
    l.maxStacks &&
        l.maxStacks < s.length &&
        (v.plugins.annotation = {
            annotations: {
                capLine: {
                    type: 'line',
                    xMin: l.maxStacks - 0.5,
                    xMax: l.maxStacks - 0.5,
                    borderColor: '#f39c12',
                    borderWidth: 2,
                    borderDash: [5, 5],
                    label: { display: r, content: 'MAX', position: 'start', backgroundColor: '#f39c12', color: '#000' },
                },
            },
        });
    const w = new an(y, { type: 'line', data: { labels: g, datasets: x }, options: v });
    return ((co[i] = w), w);
}
function xo(i, s) {
    const n = t(i);
    if (!n)
        return (
            e.warn({ operation: 'chart.init', data: { chartId: i, reason: 'canvas_not_found', chartType: 'compare' } }),
            null
        );
    co[i] && co[i].destroy();
    const o = ['#e94560', '#4ecdc4', '#f9ca24'],
        r = s.map(t => t.scaling_per_stack?.length || 0),
        a = r.length > 0 ? Math.max(...r) : 10,
        h = Array.from({ length: Math.min(a, 10) }, (t, e) => `${e + 1}`),
        l = s.map((t, e) => {
            let i = t.scaling_per_stack?.slice(0, 10) || [];
            return (
                'hyperbolic' === t.scaling_formula_type && (i = uo(i, t.hyperbolic_constant || 1)),
                {
                    label: t.name,
                    data: i,
                    borderColor: o[e % o.length],
                    backgroundColor: `${o[e % o.length]}33`,
                    fill: !1,
                    tension: 0.3,
                    pointRadius: 4,
                    borderWidth: 2,
        ...
        d = new an(c, {
            ...
            options: {
                ...
                scales: {
                    x: { title: { display: !0, text: 'Stacks' }, grid: { color: 'rgba(255, 255, 255, 0.1)' } },
                    y: {
...
function mo(t, e = 10) {
    const i = t?.value_per_level;
    if (!i || 'string' != typeof i) return null;
    const s = i.match(/[+-]?([\d.]+)/);
    if (!s || !s[1]) return null;
    const n = parseFloat(s[1]),
        o = i.includes('x'),
        r = i.toLowerCase().includes('hyperbolic'),
        a = (t.stat_affected || '').toLowerCase(),
        h = a.includes('evasion'),
        l = a.includes('armor');
    return Array.from({ length: e }, (t, e) => {
        const i = (o ? 100 * n : n) * (e + 1);
        if (r && h) {
            const t = i / 100,
                e = (t / (1 + t)) * 100;
...
function bo() {
    i('items').forEach(t => {
        if (t.scaling_per_stack && !t.one_and_done && 'flat' !== t.graph_type) {
            const e = go(t),
                i = {
                    scalingFormulaType: t.scaling_formula_type || 'linear',
                    hyperbolicConstant: t.hyperbolic_constant || 1,
                    maxStacks: t.max_stacks || void 0,
                };
            po(`chart-${t.id}`, t.scaling_per_stack, t.name, t.scaling_type || '', !1, t.secondary_scaling, e, i);
        }
    });
}
function _o() {
    i('tomes').forEach(t => {
        const e = mo(t);
        e && po(`tome-chart-${t.id}`, e, t.name, t.stat_affected ?? '', !1);
    });
}
function yo() {
...
export {
    uo as applyHyperbolicScaling,
    mo as calculateTomeProgression,
    co as chartInstances,
    xo as createCompareChart,
    po as createScalingChart,
    yo as destroyAllCharts,
    fo as generateHyperbolicValues,
    go as getEffectiveStackCap,
    bo as initializeItemCharts,
    _o as initializeTomeCharts,
};
//# sourceMappingURL=charts-pq79q7sB.js.map
