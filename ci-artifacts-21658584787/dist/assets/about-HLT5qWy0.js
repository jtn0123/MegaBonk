import { a as n, e as a, n as s } from './main-BWYXOf-Y.js';
...
function t() {
    ...
    const e = '4ce3eaf',
        ...
        l = new Date('2026-02-04T04:14:00.300Z').toLocaleDateString('en-US', {
            year: 'numeric',
            month: 'short',
            day: 'numeric',
            hour: '2-digit',
