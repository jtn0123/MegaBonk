...
async function main() {
    ...
    console.log('|--------------|-----------|----|----|-----|-----------|--------|-----|');
    console.log(
        `| V1 (curated) | ${String(v1Templates.size).padStart(9)} | ${String(v1Result.totalTP).padStart(2)} | ${String(v1Result.totalFP).padStart(2)} | ${String(v1Result.totalFN).padStart(3)} | ${(v1Result.precision * 100).toFixed(1).padStart(8)}% | ${(v1Result.recall * 100).toFixed(1).padStart(5)}% | ${(v1Result.f1 * 100).toFixed(1).padStart(4)}% |`
    );
    console.log(
        `| Summary      | ${String(summaryTemplates.size).padStart(9)} | ${String(summaryResult.totalTP).padStart(2)} | ${String(summaryResult.totalFP).padStart(2)} | ${String(summaryResult.totalFN).padStart(3)} | ${(summaryResult.precision * 100).toFixed(1).padStart(8)}% | ${(summaryResult.recall * 100).toFixed(1).padStart(5)}% | ${(summaryResult.f1 * 100).toFixed(1).padStart(4)}% |`
    );
    console.log(
        `| Combined     | ${String(combinedTemplates.size).padStart(9)} | ${String(combinedResult.totalTP).padStart(2)} | ${String(combinedResult.totalFP).padStart(2)} | ${String(combinedResult.totalFN).padStart(3)} | ${(combinedResult.precision * 100).toFixed(1).padStart(8)}% | ${(combinedResult.recall * 100).toFixed(1).padStart(5)}% | ${(combinedResult.f1 * 100).toFixed(1).padStart(4)}% |`
    );
}
