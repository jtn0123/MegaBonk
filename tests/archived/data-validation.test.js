...
function validateWeapon(weapon) {
    ...
    if (
        weapon.crit_chance !== undefined &&
        (typeof weapon.crit_chance !== 'number' || weapon.crit_chance < 0 || weapon.crit_chance > 100)
    ) {
...
function validateCharacter(character) {
    ...
    if (
        character.crit_chance !== undefined &&
        (typeof character.crit_chance !== 'number' || character.crit_chance < 0)
    ) {
        errors.push('crit_chance must be a non-negative number');
    }
    if (
        character.crit_damage !== undefined &&
        (typeof character.crit_damage !== 'number' || character.crit_damage < 100)
    ) {
