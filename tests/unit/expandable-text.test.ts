...
describe('Expandable Text', () => {
    ...
    describe('toggleTextExpand()', () => {
        it('should expand truncated text on click', () => {
            const fullText =
                'This is a very long description that exceeds the 120 character limit and should be truncated initially but expand when clicked by the user.';
      ...
      `;
        ...
        it('should collapse expanded text on second click', () => {
            const fullText =
                'This is a very long description that exceeds 120 chars and needs to be truncated when collapsed again by the user clicking.';
    ...
    describe('Expandable Text Integration', () => {
        it('should create expandable description for long text', () => {
            const longDescription =
                'This is a detailed description of an item that explains all of its effects and mechanics in great detail, which requires more than 120 characters.';
