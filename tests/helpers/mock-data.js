...
export function createExtendedMockData() {
  ...
  mockData.items.items = [
    ...
    createMockItem({ id: 'anvil', name: 'Anvil', tier: 'SS', rarity: 'rare', one_and_done: true, stacks_well: false }),
    createMockItem({ id: 'forbidden_juice', name: 'Forbidden Juice', tier: 'A', rarity: 'epic', stacks_well: true }),
