import { a as n, e as a, n as s } from './main-Da4TIoXx.js';
const i = 'https://github.com/jtn0123/MegaBonk';
function t() {
    const t = n('aboutContainer');
    if (!t) return;
    const o = '119c752',
        e = (function () {
            const n = s('items'),
            ...
            return {
                ...
                weapons: a?.length || 0,
                tomes: i?.length || 0,
                characters: t?.length || 0,
                shrines: o?.length || 0,
            };
        })(),
        l = new Date('2026-02-04T18:18:31.565Z').toLocaleDateString('en-US', {
            year: 'numeric',
            month: 'short',
            day: 'numeric',
            hour: '2-digit',
