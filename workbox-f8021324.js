define(['exports'], function (t) {
    ...
    function E(t) {
        return 'function' == typeof t
            ...
            : (t instanceof IDBTransaction &&
              ...
              (e = t),
              (m || (m = [IDBDatabase, IDBObjectStore, IDBIndex, IDBCursor, IDBTransaction])).some(t => e instanceof t)
                  ? new Proxy(t, x)
                  : t);
        var e;
    }
    ...
    x = (t => g({}, t, { get: (e, s, n) => k(e, s) || t.get(e, s, n), has: (e, s) => !!k(e, s) || t.has(e, s) }))(x);
    try {
    ...
    class j {
        ...
        async expireEntries(t, e) {
            ...
            for (; n; ) {
                const s = n.value;
                (s.cacheName === this.u && ((t && s.timestamp < t) || (e && i >= e) ? r.push(n.value) : i++),
                    (n = await n.continue()));
            }
            const a = [];
            for (const t of r) (await s.delete(M, t.id), a.push(t.url));
            return a;
        }
        m(t) {
            return this.u + '|' + T(t);
    ...
    class H {
        ...
        async M(t, e, n) {
            ...
            try {
                if (((r = await this.j(e, t)), !r || 'error' === r.type)) throw new s('no-response', { url: e.url });
            } catch (s) {
...
//# sourceMappingURL=workbox-f8021324.js.map
